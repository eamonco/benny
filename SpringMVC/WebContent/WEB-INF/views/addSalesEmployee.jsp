...
<html>
	<head>
		...
		<title>Add Sales Employee</title>
...
<div>
    ...
    <span class="text" style="display:table-cell; vertical-align:middle; horizontal-align:left">Add Sales Employee
			...
			<div>
				<form  class="col s12" style="margin-top:10px" method="post" name="employee" action="salesEmployeeForm.mvc">
		  			<div class="row">
      				...
      				<div class="row">
        				<div class="input-field col s6">
          					<input placeholder="Commission Rate" name="commissionRate" type="text" class="validate">
        				</div>
      				</div>
